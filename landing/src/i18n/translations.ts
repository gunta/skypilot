export const translations = {
  en: {
    ...
    'solutions.title': 'Sky Pilot gives you...',
    ...
    'features.command.desc1': 'npx sky-pilot - zero config, instant start',
    ...
    'features.privacy.desc1': 'No telemetry, no tracking',
    'features.privacy.desc2': 'Your videos stay on your machine',
    'features.privacy.desc3': 'API key stored locally only',
    ...
    // Coming Soon
    'coming.title': 'The Future of Sky Pilot',
    ...
    'faq.a1': 'No. Sky Pilot is an unofficial, community-built tool. We\'re not affiliated with OpenAI.',
    'faq.q2': 'How much does Sky Pilot cost?',
    'faq.a2': 'Sky Pilot is 100% free and open source (MIT license). You pay OpenAI directly for API usage—we don\'t charge anything.',
    'faq.q3': 'Where is my API key stored?',
    'faq.a3': 'In your environment variables or local .env file. It never touches our servers because Sky Pilot runs entirely on your machine.',
    ...
    'faq.a5': 'Yes! Sky Pilot is MIT licensed. Use it for personal projects, commercial work, or integrate it into your own apps.',
    ...
    'faq.q7': 'When will the GUI be available?',
    'faq.a7': 'We\'re actively developing it. Star the repo on GitHub to get notified of new releases.',
  ...
  ja: {
    ...
    'solutions.title': 'Sky Pilot が提供するもの...',
    ...
    'features.command.desc1': 'npx sky-pilot - 設定不要、即座に開始',
    ...
    'features.privacy.desc1': 'テレメトリなし、トラッキングなし',
    'features.privacy.desc2': '動画はあなたのマシンに残ります',
    'features.privacy.desc3': 'API キーはローカルにのみ保存',
    ...
    'faq.a1': 'いいえ。Sky Pilot はコミュニティが構築した非公式ツールです。OpenAI とは提携していません。',
    'faq.q2': 'Sky Pilot の料金はいくらですか？',
    'faq.a2': 'Sky Pilot は 100% 無料でオープンソース（MIT ライセンス）です。API 使用料は OpenAI に直接支払います—私たちは何も請求しません。',
    'faq.q3': 'API キーはどこに保存されますか？',
    'faq.a3': '環境変数またはローカルの .env ファイルに保存されます。Sky Pilot は完全にあなたのマシン上で実行されるため、私たちのサーバーには触れません。',
    'faq.q4': 'CLI と TUI の違いは何ですか？',
    'faq.a4': 'CLI は素早い一回限りのコマンド用です。TUI はすべてのジョブ、進行状況、コストをリアルタイムで表示するフルダッシュボードインターフェースです。',
    'faq.q5': '本番環境で使用できますか？',
    'faq.a5': 'はい！Sky Pilot は MIT ライセンスです。個人プロジェクト、商用作業、または独自のアプリに統合できます。',
    'faq.q6': 'リミックス/画像から動画をサポートしていますか？',
    'faq.a6': 'はい！--input-reference フラグで参照画像を提供するか、既存の動画には remix コマンドを使用します。',
    'faq.q7': 'GUI はいつ利用可能になりますか？',
    'faq.a7': '積極的に開発中です。GitHub でリポジトリにスターを付けて新しいリリースの通知を受け取ってください。',
